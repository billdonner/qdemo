...
struct RoundedTextViewGradient: View {
  let text: String
...
struct RoundedTextViewNoGradient: View {
  let text: String
  let backgroundColor: Color
  var body: some View {
    VStack {
